<%
' ============================================================================
'  send_email_ad.asp  -  SPR legacy pages: send mail through the MailGateway
'
...
'     session("pdf1")           site-relative path of the uploaded file, e.g. ad-recruit\file.pdf
'                               (optional: empty = send without an attachment)
...
' ---- optional attachment: session("pdf1") is the path relative to the site root ----
If Len(Trim(session("pdf1") & "")) > 0 Then
    ...
    sea_fileName = Mid(sea_relPath, InStrRev(sea_relPath, "/") + 1)
...
If sea_ok Then
    ...
    sea_body = "{"
    sea_body = sea_body & """appName"":""SPR legacy site"","
